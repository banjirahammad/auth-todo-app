  ...
  <section class="bg-[#FB186B]" id="app">
    ...
    <div class="container h-screen flex justify-center items-center">
      <div class="flex flex-col justify-center items-center">
        <!-- Login form -->
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" @submit.prevent="submitFrom">
          <div class="mb-4 w-80">
          ...
          <div class="flex items-center justify-between">
            <button v-if="msg ? '' : 'disabled'"
              class="bg-[#FB186B] hover:bg-[#20665d] text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
              type="submit">
              Sign In
            </button>
            <RouterLink :to="{ name: 'register' }"
              class="inline-block align-baseline font-bold text-sm text-[#FB186B] hover:text-[#20665d]">
              Or Register
            </RouterLink>
          </div>
        </form>
